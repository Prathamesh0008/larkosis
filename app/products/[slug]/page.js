      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-[#fff7f1] via-[#fbe4d5] to-[#fffbf8]">
        ...
        <div className="relative mx-auto w-full max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
          <nav className="flex flex-wrap items-center gap-2 text-sm" aria-label="Breadcrumb">
            <Link href="/" className="text-[#6d4832] transition-colors hover:text-[#e36c0a]">
              Home
            </Link>
            <svg className="h-4 w-4 text-[#b18b75]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
            </svg>
            <Link href="/products" className="text-[#6d4832] transition-colors hover:text-[#e36c0a]">
              Products
            </Link>
            <svg className="h-4 w-4 text-[#b18b75]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
            </svg>
            <span className="max-w-[200px] truncate font-semibold text-[#e36c0a] sm:max-w-xs">
              {product.name}
            </span>
          </nav>
          ...
          <div className="mt-6 max-w-4xl">
            <div className="flex flex-wrap items-center gap-2 sm:gap-3">
              <span className="max-w-full break-words rounded-full bg-[#ec671f]/10 px-3 py-1 text-xs font-bold uppercase tracking-wider text-[#ec671f]">
                {product.category}
              </span>
              {pharmSpec && (
                <span className="max-w-full break-words rounded-full bg-[#0f3558]/10 px-3 py-1 text-xs font-bold uppercase tracking-wider text-[#0f3558]">
                  {pharmSpec}
                </span>
              )}
              {casId && (
                <span className="max-w-full break-words rounded-full bg-[#00923f]/10 px-3 py-1 text-xs font-bold uppercase tracking-wider text-[#00923f]">
                  CAS: {casId}
                </span>
              )}
            </div>
            <h1 className="mt-3 break-words text-3xl font-bold text-[#251b14] sm:text-5xl lg:text-6xl">
              {product.name}
            </h1>
            <p className="mt-4 max-w-3xl break-words text-lg text-[#5e4435]">
        ...
        <div className="space-y-6 lg:col-span-2">
          <article className="rounded-2xl border border-[#f2d6c4] bg-white p-6 shadow-lg sm:p-8">
            ...
            <div className="mt-6 grid gap-4 sm:grid-cols-2">
              <div className="rounded-xl border border-[#efd6c6] bg-gradient-to-br from-[#fff7f2] to-[#fff] p-4">
                <dt className="text-xs font-semibold uppercase tracking-wider text-[#9b552d]">Category</dt>
                <dd className="mt-1 break-words text-lg font-semibold text-[#37261c]">{product.category}</dd>
              </div>

              <div className="rounded-xl border border-[#efd6c6] bg-gradient-to-br from-[#fff7f2] to-[#fff] p-4">
                <dt className="text-xs font-semibold uppercase tracking-wider text-[#9b552d]">Dosage Form</dt>
                <dd className="mt-1 break-words text-lg font-semibold text-[#37261c]">{product.dosageForm}</dd>
              </div>

              <div className="rounded-xl border border-[#efd6c6] bg-gradient-to-br from-[#fff7f2] to-[#fff] p-4">
                <dt className="text-xs font-semibold uppercase tracking-wider text-[#9b552d]">Strength</dt>
                <dd className="mt-1 break-words text-lg font-semibold text-[#37261c]">{product.strength}</dd>
              </div>

              {packSize && (
                <div className="rounded-xl border border-[#efd6c6] bg-gradient-to-br from-[#fff7f2] to-[#fff] p-4">
                  <dt className="text-xs font-semibold uppercase tracking-wider text-[#9b552d]">Pack Size</dt>
                  <dd className="mt-1 break-words text-lg font-semibold text-[#37261c]">{packSize}</dd>
                </div>
              )}
            </div>
            ...
            <div className="mt-6 rounded-xl border border-[#efd6c6] bg-gradient-to-br from-[#fffdfb] to-white p-5">
              ...
              <p className="mt-3 break-words text-base leading-relaxed text-[#5f4536]">
                {product.details}
              </p>
            </div>
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              <a
                ...
                className="group relative inline-flex w-full items-center justify-center gap-2 overflow-hidden rounded-xl bg-[#00923f] px-6 py-3 text-sm font-bold text-white transition-all hover:bg-[#007e35] hover:shadow-lg sm:w-auto"
              >
              ...
              <Link
                href="/contact"
                className="inline-flex w-full items-center justify-center gap-2 rounded-xl border-2 border-[#e5bca3] bg-white px-6 py-3 text-sm font-bold text-[#7c4728] transition-all hover:bg-[#fff6f0] hover:shadow-md sm:w-auto"
              >
                <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="mt-6 overflow-x-auto rounded-xl border border-[#efd6c6]">
              <table className="min-w-[560px] divide-y divide-[#efd6c6] sm:min-w-full">
                <tbody className="divide-y divide-[#efd6c6]">
                  ...
                  <tr className="bg-[#fff9f5]">
                    <td className="w-40 px-4 py-3 text-sm font-semibold text-[#37261c]">Dosage Form</td>
                    <td className="break-words px-4 py-3 text-sm text-[#5f4536]">{product.dosageForm}</td>
                  </tr>
                  <tr>
                    <td className="w-40 px-4 py-3 text-sm font-semibold text-[#37261c]">Strength</td>
                    <td className="break-words px-4 py-3 text-sm text-[#5f4536]">{product.strength}</td>
                  </tr>
                  {packSize && (
                    <tr className="bg-[#fff9f5]">
                      <td className="w-40 px-4 py-3 text-sm font-semibold text-[#37261c]">Pack Size</td>
                      <td className="break-words px-4 py-3 text-sm text-[#5f4536]">{packSize}</td>
                    </tr>
                  )}
                  {pharmSpec && (
                    <tr>
                      <td className="w-40 px-4 py-3 text-sm font-semibold text-[#37261c]">Pharmacopoeia</td>
                      <td className="break-words px-4 py-3 text-sm text-[#5f4536]">{pharmSpec}</td>
                    </tr>
                  )}
                  {casId && (
                    <tr className="bg-[#fff9f5]">
                      <td className="w-40 px-4 py-3 text-sm font-semibold text-[#37261c]">CAS ID</td>
                      <td className="break-words px-4 py-3 text-sm text-[#5f4536]">{casId}</td>
                    </tr>
                  )}
                  <tr className="bg-[#fff9f5]">
                    <td className="w-40 px-4 py-3 text-sm font-semibold text-[#37261c]">Product ID</td>
                    <td className="break-words px-4 py-3 text-sm text-[#5f4536]">{product.id}</td>
                  </tr>
                </tbody>
              </table>
            </div>
          ...
          <aside className="rounded-2xl border border-[#f2d6c4] bg-gradient-to-br from-[#0f3558] to-[#1a4a73] p-6 text-white shadow-lg">
            ...
            <div className="mt-4 space-y-2">
              <a
                ...
                className="flex items-center gap-2 break-all rounded-lg bg-white/10 px-4 py-2 text-sm font-semibold text-white transition-colors hover:bg-white/20"
              >
      ...
      {relatedProducts.length > 0 && (
        <section className="mx-auto mt-12 w-full max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-6 flex flex-col items-start justify-between gap-3 sm:flex-row sm:items-end">
            ...
            <Link
              href="/products"
              className="group flex items-center gap-1 text-sm font-bold text-[#ec671f] transition-all hover:gap-2"
            >
              View All Products
