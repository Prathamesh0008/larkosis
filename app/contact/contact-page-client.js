  ...
  return (
    <div className="min-h-screen bg-[#fff8f5] pt-20">
      <section className="mx-auto max-w-7xl px-6 pb-20 md:px-16">
        <ScrollReveal className="mb-12" variant="down">
          <h1 className="text-3xl font-bold text-[#241913] md:text-4xl">
            {t.title || "Contact Larksois Pharma"}
          </h1>
          <p className="mt-2 max-w-2xl text-[#5f4638]">
            {t.subtitle ||
              "Reach out to us for product inquiries, export discussions, documentation support, and quotation-based pharmaceutical requirements."}
          </p>
        </ScrollReveal>

        <div className="grid items-stretch gap-10 lg:grid-cols-[1.2fr_1fr]">
          <ScrollReveal className="min-w-0" delay={100} variant="left">
            <ContactForm />
          </ScrollReveal>
          ...
          >
            ...
            <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
              <h2 className="text-lg font-semibold">
                {t.formTitle || "Visit Or Write To Us"}
              </h2>
              <div className="mt-4 space-y-3 text-sm leading-7 text-white/90">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span>
                    {t.formSubtitle || "Business response window: within 24 hours"}
                  </span>
                </div>
              </div>
            </div>
