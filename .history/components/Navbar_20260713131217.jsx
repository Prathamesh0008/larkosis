...
export default function Navbar({ companyProfile }) {
  ...
  return (
    <nav className="fixed inset-x-0 top-0 z-50 w-full overflow-x-clip bg-white/95 shadow-md backdrop-blur-md">
      <div className="mx-auto flex h-[64px] w-full max-w-7xl min-w-0 items-center justify-between px-4 sm:h-[80px] sm:px-6 xl:px-10 2xl:px-0">
        <Link href="/" className="flex min-w-0 shrink-0 items-center">
          <Image
            ...
            height={80}
            priority
            className="mt-3 h-11 w-auto origin-left scale-[1.7] object-contain sm:h-15 sm:scale-[1.75] lg:h-[59px] lg:scale-[1.85] xl:h-14 xl:scale-[1.9]"
          />
        </Link>
      ...
      {menuOpen && (
        <div className="w-full max-w-full overflow-x-hidden max-h-[calc(100dvh-64px)] overflow-y-auto border-t border-gray-100 bg-white/95 px-4 py-4 shadow-2xl backdrop-blur-md animate-[mobileMenuSlide_0.28s_ease-out] lg:hidden">
