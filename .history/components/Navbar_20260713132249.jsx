      ...
      <div className="mx-auto flex h-[72px] w-full max-w-7xl min-w-0 items-center justify-between px-4 sm:h-[95px] sm:px-6 lg:h-[96px] xl:px-10 2xl:px-0">
        <Link href="/" className="flex min-w-0 shrink-0 items-center">
          <Image
            ...
            height={80}
            priority
            className="h-11 mt-5 w-auto origin-left scale-[1.7] object-contain sm:h-[52px] sm:scale-[1.8] lg:h-16 lg:scale-[1.75] xl:h-20 xl:scale-[1.8] 2xl:h-24 2xl:scale-[1.9]"
          />
        </Link>
