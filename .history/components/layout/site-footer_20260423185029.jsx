...
export default function SiteFooter({ companyProfile, year }) {
  ...
  return (
    <footer className="relative mt-1 overflow-hidden border-t border-[#f1d8c8] bg-[#fffaf6]">
      ...
      <div className="relative mx-auto w-full max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="mb-10 flex flex-col items-center justify-between gap-6 pb-8 text-center lg:flex-row lg:text-left">
