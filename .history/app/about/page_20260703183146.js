      ...
      <ScrollReveal as="section" className="bg-[#fbf7f3] py-20 sm:py-28" delay={160} variant="right">
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          <div className="mb-8 text-center sm:mb-10">
            ...
            <h2 className="mt-4 text-3xl font-bold text-[#241913] sm:text-4xl md:text-5xl">
              Values That Guide Larksois Pharma
            </h2>
          </div>
          ...
          <div className="mx-auto grid max-w-5xl gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {valuePoints.map((value) => (
              <div
                key={value}
                className="flex min-h-[128px] flex-col items-center justify-center rounded-[26px] border border-[#e7edf3] bg-white p-6 text-center shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-lg"
              >
                <div className="mb-5 flex h-10 w-10 items-center justify-center rounded-full bg-[#e8f6fb] text-[#1ca5d8]">
                  <svg
                    className="h-5 w-5"
                    fill="none"
                    stroke="currentColor"
                ...
                <h3 className="text-[1.7rem] font-bold text-[#102d47]">{value}</h3>
              </div>
            ))}
          </div>
        </div>
